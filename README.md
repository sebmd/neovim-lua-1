...
| funkcja             | opis                                                  |
| ------------------- | ----------------------------------------------------- |
| `InsertDiaryHeader` | wywołuje funkcję `InsertDiaryHeader`                  |
| `DiaryNotes`        | wywołuje funkcję `DiaryNotes`                         |
| `VimrcVersion`      | wywołuje funkcję `VimrcVersion`                       |
| `GP`                | wywołuje funkcję `GP`                                 |
| `GA`                | wywołuje funkcję `GA`                                 |
...
| `Write`             | wywołuje funkcję `Write`                              |
| `Time`              | wywołuje funkcję `Time`                               |
| `Doku2MD`           | wywołuje funkcję `Doku2MD`                            |

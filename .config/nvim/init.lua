-- Aktualizacja 2021-09-19 07:59:47
...
-- { book_marks = "SPC k b" },
-- { change_colorscheme = "SPC k c" },
-- { find_file = "SPC k f" },
-- { find_history = "SPC k h" },
-- { find_word = "SPC k w" },
-- { last_session = "SPC k s" },
-- { new_file = "SPC k n" },
-- }
...
-- Jeśli jest włączony Dashboard to pojedyncze wciśnięcie q zamyka edytor
api.nvim_exec(
    [[
